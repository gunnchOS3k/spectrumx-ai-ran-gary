# LEGACY — class diagram detection (aspirational ML stack)

| | |
|---|---|
| **Status** | **Legacy** |
| **Why archived** | Many classes not wired as shown for dashboard inference; prefer current submission path. |
| **Source** | [`docs/uml/class_diagram_detection.mmd`](../class_diagram_detection.mmd) |
